				...
				<div className='modal-dialog modal-dialog-centered'>
					<div className='modal-content'>
						...
						<div className='modal-body'>
							<h4 className='fw-lighter mb-4'>¡Gracias por tu compra!</h4>
							<p>Tu pedido ha sido procesado con éxito.</p>
							<p>
								<strong>Códigio de Pedido:</strong> #{id}
							</p>
				...
				<div className=' animate__animated animate__fadeIn mb-5 p-4'>
					<div className='row justify-content-center'>
						<div className='col-12 col-lg-6'>
							<h3 className='text-center product-description-cart fw-bold mb-5'>
								Datos de contacto
							</h3>
							<form className='form'>
									...
									<div className='col-12'>
										<div className='form-floating'>
											<input
												...
												value={isLoggedIn ? user.displayName : undefined}
									...
									<div className='col-12'>
										<div className='form-floating'>
											<input
												...
												name='email'
												placeholder='name@example.com'
												value={isLoggedIn ? user.email : undefined}
												disabled={isLoggedIn ? true : false}
											/>
						...
						<div className='col-12 col-lg-4 product-description-cart mt-5 mt-lg-0'>
							...
							<br />
							{cart.map(item => (
								<div className='mb-2 mt-2' key={item.id}>
